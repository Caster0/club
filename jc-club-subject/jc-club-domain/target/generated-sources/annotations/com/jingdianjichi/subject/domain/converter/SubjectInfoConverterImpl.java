...
public class SubjectInfoConverterImpl implements SubjectInfoConverter {
    ...
    @Override
    public SubjectInfo converterBOToInfo(SubjectInfoBO subjectInfoBO) {
    ...
    @Override
    public SubjectInfoBO converterOptionAndInfoToBO(SubjectOptionBO subjectOptionBO, SubjectInfo subjectInfo) {
    ...
    @Override
    public List<SubjectInfoBO> converterListInfoToBo(List<SubjectInfo> subjectInfoList) {
