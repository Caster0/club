...
public class SubjectJudgeConverterImpl implements SubjectJudgeConverter {
    ...
    @Override
    public SubjectJudge converterBOToEntity(SubjectAnswerBO subjectAnswerBO) {
    ...
    @Override
    public List<SubjectAnswerBO> converterEntityToBoList(List<SubjectJudge> subjectJudgeList) {
