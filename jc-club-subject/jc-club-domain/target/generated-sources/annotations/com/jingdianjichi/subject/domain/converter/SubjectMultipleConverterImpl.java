...
public class SubjectMultipleConverterImpl implements SubjectMultipleConverter {
    ...
    @Override
    public SubjectMultiple converterBOToEntity(SubjectAnswerBO subjectAnswerBO) {
    ...
    @Override
    public List<SubjectAnswerBO> converterEntityToBoList(List<SubjectMultiple> subjectMultipleList) {
